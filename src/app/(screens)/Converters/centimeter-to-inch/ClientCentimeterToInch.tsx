...
export default function ClientCentimeterToInch() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Convert Centimeters to Inches</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-4 p-4 bg-muted rounded-lg">
          <p className="text-sm text-muted-foreground">
            <strong>Formula:</strong> inches = centimeters ÷ 2.54
          </p>
        </div>
      </CardContent>
    </Card>
