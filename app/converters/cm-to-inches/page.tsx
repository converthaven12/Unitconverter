      ...
      <main className="p-6 lg:p-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <p>
              Converting centimeters to inches is one of the most common unit conversions, especially when dealing with
              international measurements or working between metric and imperial systems.
            </p>
            <p>
              The conversion factor is straightforward: 1 inch equals exactly 2.54 centimeters, which means 1 centimeter
              equals approximately 0.393701 inches.
            </p>
            <p>
            ...
            <p>
              The inch has ancient origins, originally based on the width of a human thumb, and was standardized in 1959
              as exactly 2.54 centimeters.
            </p>
            <p>
              Today, most countries use the metric system, but the United States, United Kingdom, and a few others still
              use imperial measurements in daily life.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p>
                  For a rough estimate, divide by 2.5 instead of 2.54. This gives you a close approximation that's easy
                  to calculate mentally. For example, 25 cm ÷ 2.5 = 10 inches (actual: 9.84 inches).
                </p>
              </div>
              <div>
                <h3>Why is the conversion factor 2.54 exactly?</h3>
                <p>
                  In 1959, the international yard and pound agreement defined the inch as exactly 2.54 centimeters. This
                  created a precise relationship between metric and imperial units.
                </p>
              </div>
            </div>
